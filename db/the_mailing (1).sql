...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2022 at 09:03 AM
...
--
-- Table structure for table `loop_configuration`
--

CREATE TABLE `loop_configuration` (
  `id` int(11) NOT NULL,
  `mail_no` int(1) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `loop_configuration`
--

INSERT INTO `loop_configuration` (`id`, `mail_no`) VALUES
(1, 1);
...
CREATE TABLE `mail_template` (
  ...
  `msg_2` text DEFAULT NULL,
  `subject_3` varchar(255) DEFAULT NULL,
  `msg_3` text DEFAULT NULL,
...
INSERT INTO `mail_template` (`id`, `from`, `cc`, `bcc`, `name`, `subject`, `msg`, `subject_2`, `msg_2`, `subject_3`, `msg_3`, `template`, `status`) VALUES
(1, 'hm.younas22@gmail.com', 'hm.younas22@gmail.com', 'hm.younas22@gmail.com', NULL, 'contact', 'The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without the written consent of the sender. \r\n\r\n<b>Hello</b>\r\n\r\n<br><br>Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.', 'about', 'The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. \r\n\r\n<b>Hello</b>\r\n\r\n<br><br>Unauthorized use, disclosure, or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.', 'abc', 'The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. \r\n\r\n<b>Hello</b>\r\n\r\n<br><br>Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.The content of this email is confidential and intended for the recipient specified in the message only. It is strictly forbidden to share any part of this message with any third party, without a written consent of the sender. Unauthorized use, disclosure or copying of this message or any part thereof is strictly prohibited and may be unlawful. If you received this message by mistake, please reply to this message and follow with its deletion, so that we can ensure such a mistake does not occur in the future.', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `second_mail`
--

CREATE TABLE `second_mail` (
  `id` int(11) NOT NULL,
  `email` varchar(255) DEFAULT NULL,
  `status` enum('1','0') NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `second_mail`
--

INSERT INTO `second_mail` (`id`, `email`, `status`) VALUES
(1, 'phpfiverrpk@gmail.com', '0'),
(2, 'muhammadsadique116@gmail.com', '0');
...
--
-- Table structure for table `therd_mail`
--

CREATE TABLE `therd_mail` (
  `id` int(11) NOT NULL,
  `email` varchar(255) DEFAULT NULL,
  `status` enum('1','0') NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `therd_mail`
--

INSERT INTO `therd_mail` (`id`, `email`, `status`) VALUES
(1, 'phpfiverrpk@gmail.com', '0'),
(2, 'muhammadsadique116@gmail.com', '0');
...
--
-- Indexes for table `loop_configuration`
--
ALTER TABLE `loop_configuration`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `second_mail`
--
ALTER TABLE `second_mail`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `therd_mail`
--
ALTER TABLE `therd_mail`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `loop_configuration`
--
ALTER TABLE `loop_configuration`
...
--
-- AUTO_INCREMENT for table `second_mail`
--
ALTER TABLE `second_mail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `therd_mail`
--
ALTER TABLE `therd_mail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

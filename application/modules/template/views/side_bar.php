            ...
            <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true"
                ...
                <div class="user-panel">
                  <div class="row">
                    <div class="sidebar-userpic">
                      <img src="<?=base_url()?>assets/img/dp.jpg" class="img-responsive" alt=""> </div>
                  </div>
                  <div class="profile-usertitle">
                    <div class="sidebar-userpic-name"> Anang Panday </div>
              ...
              <li class="nav-item">
                ...
                <ul class="sub-menu">
                  ...
                  <li class="nav-item">
                    <a href="<?=base_url('dashboard/email-compose')?>" class="nav-link ">
              ...
              <li class="menu-heading m-t-20 d-none">

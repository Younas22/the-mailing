...
<head>
  ...
  <link href="<?=base_url('assets')?>/plugins/jquery-tags-input/jquery-tags-input.css" rel="stylesheet" type="text/css" />
  ...
  <link href="<?=base_url('assets')?>/css/pages/inbox.min.css" rel="stylesheet">
  <!-- Template Styles -->
          ...
          <ul class="nav navbar-nav pull-right">
                ...
                <li>
                  <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url('assets')?>/img/user/user2.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url('assets')?>/img/user/user3.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url('assets')?>/img/user/user1.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url('assets')?>/img/user/user8.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url('assets')?>/img/user/user5.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
            ...
            <li class="dropdown dropdown-user">
              <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                ...
                <span class="username username-hide-on-mobile"> Anang </span>
